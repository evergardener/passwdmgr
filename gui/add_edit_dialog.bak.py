...
class AddEditDialog(QDialog):
    ...
    def __init__(self, database_manager, encryption_manager, session_manager,
                 password_generator, config_manager=None, parent=None, entry=None):  # 添加 config_manager 参数
        super().__init__(parent)
        self.database_manager = database_manager
        self.encryption_manager = encryption_manager
        self.session_manager = session_manager
        self.password_generator = password_generator
        self.config_manager = config_manager  # 保存 config_manager
        self.entry = entry
    ...
    # 在 AddEditDialog 类中添加 load_entry_data 方法
